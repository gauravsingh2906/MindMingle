...
val Accent=Color(0xFF31C48D)
val Blue = Color(0xFF347CF6)
...
val VirtualBackground = Color(0xFFF3F7F9)
val AppBackground = Color(0xFFF8FAFF)     // Soft, slightly blueish white
val MainAccent   = Color(0xFF31C48D)      // Mint green
val AltAccent    = Color(0xFF347CF6)      // Fun blue (use blue for more energetic branding)
val RewardAccent = Color(0xFFFFAA3C)      // Gold/orange
val CardSurface  = Color.White            // Always flat for stats/cards
val TextPrimary1  = Color(0xFF222B45)
val TextSecondary1 = Color(0xFF8F9BB3)
